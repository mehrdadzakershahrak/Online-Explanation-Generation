...
:effect (and (handempty ?h)(ontable ?c)(increase (total-cost) 1)
		)
)
...
:precondition (and (holding ?h1 ?s)(contains ?s ?d1)(contains ?s ?d2)(cocktail-part1 ?b ?d1)(cocktail-part2 ?b ?d2)(unshaked ?s)
		)
