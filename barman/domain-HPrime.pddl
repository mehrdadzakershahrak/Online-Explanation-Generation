...
:effect (and (handempty ?h)(ontable ?c)(increase (total-cost) 1) (not (holding ?h ?c))
		)
)
...
:precondition (and (holding ?h1 ?s)(contains ?s ?d1)(contains ?s ?d2)(cocktail-part1 ?b ?d1)(cocktail-part2 ?b ?d2)(unshaked ?s) (handempty ?h2)
		)
