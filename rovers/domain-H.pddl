...
:precondition (and (at ?x ?p)   (store_of ?s ?x) (empty ?s) (equipped_for_soil_analysis ?x) (at_soil_sample ?p)
		)
...
(:action calibrate
 ...
 :precondition (and   (at ?r ?w) (visible_from ?t ?w)(on_board ?i ?r) (calibration_target ?i ?t)
		)
...
(:action take_image
 ...
 :precondition (and (on_board ?i ?r) (equipped_for_imaging ?r) (supports ?i ?m) (visible_from ?o ?p) (at ?r ?p) (calibrated ?i ?r)
               )
...
(:action communicate_rock_data
 :parameters (?r - rover ?l - lander ?p - waypoint ?x - waypoint ?y - waypoint)
 :precondition (and (at ?r ?x)(at_lander ?l ?y)(have_rock_analysis ?r ?p) (visible ?x ?y)(available ?r)
            )
...
(:action communicate_image_data
 ...
 :effect (and (channel_free ?l)(communicated_image_data ?o ?m)(available ?r) (not (channel_free ?l))
          )
)
